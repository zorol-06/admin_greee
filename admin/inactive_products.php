...
<head>
    ...
    <title>Green Coffee Admin Panel - Sản phẩm Ngừng hoạt động</title>
</head>
<body>
...
<div class="main">
    <div class="banner">  
        <h1>Sản phẩm Ngừng hoạt động</h1> </div>

    <div class="title2">
        <a href="dashboard.php">Bảng điều khiển</a><span> / Sản phẩm Ngừng hoạt động</span> </div>

    <section class="show-post">
         <div class="box-container">
        <?php
        // CHỈ TRUY VẤN SẢN PHẨM CÓ STATUS KHÁC 'active'
        ...
        <?php
            ...
            echo '
            <div class="empty">
                <p>Không tìm thấy sản phẩm không hoạt động/bản nháp nào!</p> </div>';
        }
        ?>   
        </div>
    </section>
